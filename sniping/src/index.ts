...
async function createSpecSnipe(mintAddr:string, takeProfit:number, stopLoss:number, slippage:number, snipeAmount:number, userId:number) {
...
async function test() {
    createSpecSnipe("EyPbL9JsvHXq7ueWCzHsdp2FYC23jiPxFGkoPfSKpump", 200, 20, 200, 0.5, 1);
}
test();