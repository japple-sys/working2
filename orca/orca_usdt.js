...
async function monitorSolUsdtRateOnOrca() {
  ...
  const SOL_USDT_WHIRLPOOL = new PublicKey(
    "FwewVm8u6tFPGewAyHmWAqad9hmF7mvqxK4mJ7iNqqGC"
  );
  const whirlpool = await client.getPool(SOL_USDT_WHIRLPOOL);
...
module.exports = { monitorSolUsdtRateOnOrca };
